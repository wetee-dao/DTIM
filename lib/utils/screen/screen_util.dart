...
class ScreenUtil {
  ...
  double get textScaleFactor {
    return MediaQueryData.fromWindow(ui.window).textScaleFactor;
  }

  /// 设备的像素密度
  /// The size of the media in logical pixels (e.g, the size of the screen).
  double? get pixelRatio => context != null ? MediaQuery.of(context!).devicePixelRatio : 1;

  /// 当前设备宽度 dp
  /// The horizontal extent of this size.
  double get screenWidth => context != null ? MediaQuery.of(context!).size.width : _screenWidth;

  ///当前设备高度 dp
  ///The vertical extent of this size. dp
  double get screenHeight => context != null ? MediaQuery.of(context!).size.height : _screenHeight;

  /// 状态栏高度 dp 刘海屏会更高
  /// The offset from the top, in dp
  double get statusBarHeight => context == null ? 0 : MediaQuery.of(context!).padding.top;

  /// 底部安全区距离 dp
  /// The offset from the bottom, in dp
  double get bottomBarHeight => context == null ? 0 : MediaQuery.of(context!).padding.bottom;
  ...
  double get scaleHeight => (_splitScreenMode ? max(screenHeight, 700) : screenHeight) / uiSize.height;
  ...
  double setWidth(num width) => width * scaleWidth * textScaleFactor;
  ...
  double setHeight(num height) => height * scaleHeight * textScaleFactor;
