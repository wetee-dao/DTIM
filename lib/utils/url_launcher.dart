...
import '../components/profile_bottom_sheet.dart';
import '../components/public_room_bottom_sheet.dart';
...
class UrlLauncher {
  ...
  void openMatrixToUrl() async {
    ...
    if (identityParts.primaryIdentifier.sigil == '#' || identityParts.primaryIdentifier.sigil == '!') {
      ...
      var room = client.getRoomByAlias(roomIdOrAlias) ?? client.getRoomById(roomIdOrAlias);
      var roomId = room?.id;
