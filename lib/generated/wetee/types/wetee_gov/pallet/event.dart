...
class Vote extends Event {
  ...
  int _sizeHint() {
    ...
    size = size + _i1.U64Codec.codec.sizeHint(value0);
    size = size + _i1.U32Codec.codec.sizeHint(value1);
    size = size + _i4.Pledge.codec.sizeHint(value2);
    return size;
  }
...
class Unlock extends Event {
  ...
  int _sizeHint() {
    int size = 1;
    size = size + const _i6.AccountId32Codec().sizeHint(value0);
