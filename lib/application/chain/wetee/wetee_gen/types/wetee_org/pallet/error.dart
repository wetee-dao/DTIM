...
enum Error {
  ...
  /// 成员数量太大
  tooManyMembers('TooManyMembers', 14),

  /// Wrong dao gov origin.
  /// 错误的dao组织账户
  badDaoGovOrigin('BadDaoGovOrigin', 15),

  /// Wrong dao gov origin.
  /// 错误的dao组织账户
  badGovOrigin('BadGovOrigin', 16),

  /// Wrong dao gov 403.
  /// 错误的dao组织账户
  badDaoGov403('BadDaoGov403', 17);
