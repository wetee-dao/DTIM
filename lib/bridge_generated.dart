...
class RustWraperImpl implements RustWraper {
  ...
  Future<String> connectWallet({dynamic hint}) {
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner.wire_connect_wallet(port_),
      parseSuccessData: _wire2api_String,
      parseErrorData: _wire2api_FrbAnyhowException,
      constMeta: kConnectWalletConstMeta,
      argValues: [],
      hint: hint,
    ));
  }
  ...
  Future<bool> daoGovStartReferendum(
    ...
    var arg4 = _platform.api2wire_u64(deposit);
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) => _platform.inner
          .wire_dao_gov_start_referendum(port_, arg0, arg1, arg2, arg3, arg4),
      parseSuccessData: _wire2api_bool,
      parseErrorData: _wire2api_FrbAnyhowException,
      constMeta: kDaoGovStartReferendumConstMeta,
      argValues: [from, client, daoId, index, deposit],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kDaoGovStartReferendumConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        ...
        argNames: ["from", "client", "daoId", "index", "deposit"],
      );
...
// Section: wire2api
  ...
  GovPeriod _wire2api_gov_period(dynamic raw) {
    final arr = raw as List<dynamic>;
    if (arr.length != 9)
      throw Exception('unexpected arr length: expect 9 but see ${arr.length}');
    return GovPeriod(
      name: _wire2api_String(arr[0]),
      preparePeriod: _wire2api_i64(arr[1]),
      maxDeciding: _wire2api_i64(arr[2]),
      confirmPeriod: _wire2api_i64(arr[3]),
      decisionPeriod: _wire2api_i64(arr[4]),
      minEnactmentPeriod: _wire2api_i64(arr[5]),
      decisionDeposit: _wire2api_i64(arr[6]),
      minApproval: _wire2api_i64(arr[7]),
      minSupport: _wire2api_i64(arr[8]),
    );
  }
  ...
  GovProps _wire2api_gov_props(dynamic raw) {
    ...
    return GovProps(
      ...
      period: _wire2api_gov_period(arr[5]),
    );
  }
  ...
  GovReferendum _wire2api_gov_referendum(dynamic raw) {
    ...
    return GovReferendum(
      ...
      hash: _wire2api_String(arr[1]),
      proposal: _wire2api_String(arr[2]),
      tally: _wire2api_tally(arr[3]),
      memberGroup: _wire2api_member_group(arr[4]),
      status: _wire2api_u8(arr[5]),
      period: _wire2api_gov_period(arr[6]),
    );
  }
...
// Section: api_fill_to_wire
  ...
  void _api_fill_to_wire_with_gov_ps(WithGovPs apiObj, wire_WithGovPs wireObj) {
    ...
    wireObj.period_index = api2wire_u32(apiObj.periodIndex);
  }
}
...
class RustWraperWire implements FlutterRustBridgeWireBase {
  ...
  void wire_connect_wallet(
    int port_,
  ) {
    return _wire_connect_wallet(
      port_,
    );
  }

  late final _wire_connect_walletPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'wire_connect_wallet');
  late final _wire_connect_wallet =
      _wire_connect_walletPtr.asFunction<void Function(int)>();
  ...
  void wire_add_seed(
    ...
    return _wire_add_seed(
      port_,
      seed,
    );
  }

  late final _wire_add_seedPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ffi.Int64, ffi.Pointer<wire_uint_8_list>)>>('wire_add_seed');
  late final _wire_add_seed = _wire_add_seedPtr
      .asFunction<void Function(int, ffi.Pointer<wire_uint_8_list>)>();
  ...
  void wire_dao_init_from_pair(
    int port_,
    int client,
    ffi.Pointer<wire_uint_8_list> address,
  ) {
    return _wire_dao_init_from_pair(
      port_,
      client,
      address,
    );
  ...
  late final _wire_dao_init_from_pairPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int64, ffi.Uint32,
              ffi.Pointer<wire_uint_8_list>)>>('wire_dao_init_from_pair');
  late final _wire_dao_init_from_pair = _wire_dao_init_from_pairPtr
      .asFunction<void Function(int, int, ffi.Pointer<wire_uint_8_list>)>();
  ...
  late final _wire_dao_gov_start_referendumPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(
              ...
              ffi.Uint64,
              ffi.Uint32,
              ffi.Uint64)>>('wire_dao_gov_start_referendum');
  ...
  late final _wire_dao_project_task_list =
      _wire_dao_project_task_listPtr.asFunction<void Function(int, int, int)>();
  ...
  void wire_dao_project_join_request_with_root(
    int port_,
    ffi.Pointer<wire_uint_8_list> from,
    int client,
    int dao_id,
    ...
    return _wire_dao_project_join_request_with_root(
      port_,
      from,
      client,
      dao_id,
  ...
  late final _wire_dao_project_join_request_with_rootPtr = _lookup<
          ffi.NativeFunction<
              ffi.Void Function(
                  ffi.Int64,
                  ffi.Pointer<wire_uint_8_list>,
                  ...
                  ffi.Pointer<wire_uint_8_list>)>>(
      'wire_dao_project_join_request_with_root');
  late final _wire_dao_project_join_request_with_root =
      _wire_dao_project_join_request_with_rootPtr.asFunction<
          void Function(int, ffi.Pointer<wire_uint_8_list>, int, int, int,
              ffi.Pointer<wire_uint_8_list>)>();
...
final class wire_MemberGroup extends ffi.Struct {
  @ffi.Uint8()
  external int scope;
...
final class wire_WithGovPs extends ffi.Struct {
  @ffi.Uint8()
