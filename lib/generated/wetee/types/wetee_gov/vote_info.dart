...
class VoteInfo {
  ...
  /// Pledge
  final _i2.Pledge pledge;

  /// Opinion
  final _i3.Opinion opinion;
...
class $VoteInfoCodec with _i1.Codec<VoteInfo> {
  ...
  void encodeTo(
    ...
    _i2.Pledge.codec.encodeTo(
      obj.pledge,
      output,
    );
    _i3.Opinion.codec.encodeTo(
      obj.opinion,
      output,
    );
  ...
  VoteInfo decode(_i1.Input input) {
    return VoteInfo(
      ...
      pledge: _i2.Pledge.codec.decode(input),
      opinion: _i3.Opinion.codec.decode(input),
  ...
  int sizeHint(VoteInfo obj) {
    ...
    size = size + _i2.Pledge.codec.sizeHint(obj.pledge);
    size = size + _i3.Opinion.codec.sizeHint(obj.opinion);
