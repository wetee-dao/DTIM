...
import '../types/wetee_app/pallet/call.dart' as _i16;
...
class Queries {
  ...
  /// Returns the storage key for `tEEApps`.
  _i8.Uint8List tEEAppsKey(
    _i3.AccountId32 key1,
    BigInt key2,
  ) {
    final hashedKey = _tEEApps.hashedKeyFor(
  ...
  /// Returns the storage map key prefix for `tEEApps`.
  _i8.Uint8List tEEAppsMapPrefix(_i3.AccountId32 key1) {
    final hashedKey = _tEEApps.mapPrefix(key1);
    return hashedKey;
  }
...
class Txs {
  ...
  _i9.RuntimeCall create({
    ...
    return _i9.RuntimeCall.values.weTEEApp(_call);
  }
