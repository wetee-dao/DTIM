        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text("4562 3325 5158 2385", style: TextStyle(color: Colors.white, fontSize: 17.w)),
              SizedBox(height: 10.w),
              Text("share: 10000", style: TextStyle(color: Colors.white, fontSize: 12.w)),
              SizedBox(height: 6.w),
              Text("wte: 10000", style: TextStyle(color: Colors.white, fontSize: 12.w)),
              SizedBox(height: 5.w),
            ],
          ),
        ),
