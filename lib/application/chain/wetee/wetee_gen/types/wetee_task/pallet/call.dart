...
class $Call {
  ...
  Create create({
    ...
    required int level,
    required _i7.TEEVersion teeVersion,
  }) {
    return Create(
      name: name,
      image: image,
...
class Create extends Call {
  ...
  int _sizeHint() {
    ...
    size = size + _i7.TEEVersion.codec.sizeHint(teeVersion);
    return size;
  }
...
class UpdatePrice extends Call {
  ...
  factory UpdatePrice._decode(_i1.Input input) {
    return UpdatePrice(
      level: _i1.U8Codec.codec.decode(input),
      price: _i8.Price.codec.decode(input),
    );
  }
  ...
  int _sizeHint() {
    int size = 1;
    size = size + _i1.U8Codec.codec.sizeHint(level);
    size = size + _i8.Price.codec.sizeHint(price);
    return size;
  }
