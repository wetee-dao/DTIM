...
class VoipPlugin with WidgetsBindingObserver implements WebRTCDelegate {
  ...
  Future<bool> get hasCallingAccount async => kIsWeb ? false : await CallKeepManager().hasPhoneAccountEnabled;
  ...
  Future<void> handleNewCall(CallSession call) async {
    if (PlatformInfos.isAndroid) {
      ...
      if (call.direction == CallDirection.kIncoming && hasCallingAccount && call.type == CallType.kVoice) {
