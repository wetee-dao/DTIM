...
class _PreloaderPageState extends State<PreloaderPage> with WindowListener {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      backgroundColor: _loading ? constTheme.sidebarBg.withOpacity(0.50) : constTheme.centerChannelBg.withOpacity(0.50),
      body: Container(
        margin: EdgeInsets.all(5.w),
        decoration: BoxDecoration(
          color: _loading ? constTheme.sidebarBg : constTheme.centerChannelBg,
