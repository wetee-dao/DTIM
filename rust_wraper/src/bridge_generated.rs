...
fn wire_orgs_impl(port_: MessagePort, client: impl Wire2Api<u32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<OrgInfo>>(
        WrapInfo {
            debug_name: "orgs",
            port: Some(port_),
            mode: FfiCallMode::Normal,
...
fn wire_app_hubs_impl(port_: MessagePort, client: impl Wire2Api<u32> + UnwindSafe) {
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<App>>(
        WrapInfo {
            debug_name: "app_hubs",
            port: Some(port_),
            mode: FfiCallMode::Normal,
...
fn wire_org_apps_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<OrgApp>>(
        WrapInfo {
            debug_name: "org_apps",
            port: Some(port_),
            mode: FfiCallMode::Normal,
...
fn wire_native_balance_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, AssetAccountData>(
        WrapInfo {
...
fn wire_dao_info_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, OrgInfo>(
        WrapInfo {
            debug_name: "dao_info",
            port: Some(port_),
            mode: FfiCallMode::Normal,
...
fn wire_dao_roadmap_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<Quarter>>(
        WrapInfo {
...
fn wire_dao_projects_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<ProjectInfo>>(
        WrapInfo {
...
fn wire_dao_guilds_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<GuildInfo>>(
        WrapInfo {
...
fn wire_dao_gov_pending_referendum_list_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<GovProps>>(
        WrapInfo {
...
fn wire_dao_gov_referendum_list_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<GovReferendum>>(
        WrapInfo {
...
fn wire_dao_gov_votes_of_user_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<GovVote>>(
        WrapInfo {
...
fn wire_dao_project_task_list_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, Vec<TaskInfo>>(
        WrapInfo {
...
fn wire_dao_project_task_info_impl(
    ...
    FLUTTER_RUST_BRIDGE_HANDLER.wrap::<_, _, _, TaskInfo>(
        WrapInfo {
