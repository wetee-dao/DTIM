...
class ChainWraperImpl implements ChainWraper {
  ...
  factory ChainWraperImpl(ExternalLibrary dylib) =>
      ChainWraperImpl.raw(ChainWraperPlatform(dylib));

  /// Only valid on web/WASM platforms.
  factory ChainWraperImpl.wasm(FutureOr<WasmModule> module) =>
      ChainWraperImpl(module as ExternalLibrary);
...
class ChainWraperWire implements FlutterRustBridgeWireBase {
  ...
  ChainWraperWire(ffi.DynamicLibrary dynamicLibrary)
      : _lookup = dynamicLibrary.lookup;

  /// The symbols are looked up with [lookup].
  ChainWraperWire.fromLookup(
