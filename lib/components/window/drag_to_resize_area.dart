...
class DragToResizeArea extends StatelessWidget {
  ...
  Widget _buildDragToResizeEdge(
    ...
    if (enableResizeEdges != null && !enableResizeEdges!.contains(resizeEdge)) return Container();
    return Container(
      width: width,
      height: height,
      ...
      child: MouseRegion(
        ...
        child: GestureDetector(
          ...
          onDoubleTap: () => (Platform.isWindows && (resizeEdge == ResizeEdge.top || resizeEdge == ResizeEdge.bottom))
