...
import '../opinion.dart' as _i5;
import '../period.dart' as _i6;
...
class $Call {
  ...
  SetPeriods setPeriods({
    required BigInt daoId,
    required List<_i6.Period> periods,
  }) {
    return SetPeriods(
      daoId: daoId,
      periods: periods,
...
class VoteForProp extends Call {
  ...
  factory VoteForProp._decode(_i1.Input input) {
    return VoteForProp(
      ...
      pledge: _i1.CompactBigIntCodec.codec.decode(input),
      opinion: _i5.Opinion.codec.decode(input),
    );
  }
  ...
  int _sizeHint() {
    ...
    size = size + _i1.CompactBigIntCodec.codec.sizeHint(pledge);
    size = size + _i5.Opinion.codec.sizeHint(opinion);
    return size;
  }
...
class SetPeriods extends Call {
  ...
  factory SetPeriods._decode(_i1.Input input) {
    return SetPeriods(
      daoId: _i1.U64Codec.codec.decode(input),
      periods:
          const _i1.SequenceCodec<_i6.Period>(_i6.Period.codec).decode(input),
    );
  }
  ...
  int _sizeHint() {
    ...
    size = size + _i1.U64Codec.codec.sizeHint(daoId);
    size = size +
        const _i1.SequenceCodec<_i6.Period>(_i6.Period.codec).sizeHint(periods);
    return size;
  }
  ...
  void encodeTo(_i1.Output output) {
    ...
    const _i1.SequenceCodec<_i6.Period>(_i6.Period.codec).encodeTo(
      periods,
      output,
    );
  }
