...
class $EventCodec with _i1.Codec<Event> {
  ...
  Event decode(_i1.Input input) {
    ...
    switch (index) {
      case 0:
        return AppCreated._decode(input);
      case 1:
  ...
  void encodeTo(
    ...
    switch (value.runtimeType) {
      case AppCreated:
        (value as AppCreated).encodeTo(output);
        break;
      case AppRuning:
  ...
  int sizeHint(Event value) {
    switch (value.runtimeType) {
      case AppCreated:
        return (value as AppCreated)._sizeHint();
      case AppRuning:
...
/// App created.
/// App创建
class AppCreated extends Event {
  const AppCreated({
    required this.creator,
    required this.id,
  });

  factory AppCreated._decode(_i1.Input input) {
    return AppCreated(
