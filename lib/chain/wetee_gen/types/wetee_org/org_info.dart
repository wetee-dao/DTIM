...
class OrgInfo {
  ...
  factory OrgInfo.decode(_i1.Input input) {
  ...
  static const $OrgInfoCodec codec = $OrgInfoCodec();
...
class $OrgInfoCodec with _i1.Codec<OrgInfo> {
  const $OrgInfoCodec();
  ...
  @override
  OrgInfo decode(_i1.Input input) {
    return OrgInfo(
