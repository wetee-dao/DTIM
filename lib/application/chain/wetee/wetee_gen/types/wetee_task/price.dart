...
class $PriceCodec with _i1.Codec<Price> {
  ...
  Price decode(_i1.Input input) {
    return Price(
      cpuPerBlock: _i1.U32Codec.codec.decode(input),
      memoryPerBlock: _i1.U32Codec.codec.decode(input),
      diskPerBlock: _i1.U32Codec.codec.decode(input),
    );
  }
  ...
  int sizeHint(Price obj) {
    int size = 0;
    size = size + _i1.U32Codec.codec.sizeHint(obj.cpuPerBlock);
    size = size + _i1.U32Codec.codec.sizeHint(obj.memoryPerBlock);
    size = size + _i1.U32Codec.codec.sizeHint(obj.diskPerBlock);
    return size;
  }
}
