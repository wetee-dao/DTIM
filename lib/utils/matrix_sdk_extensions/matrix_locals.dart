...
class MatrixLocals extends MatrixLocalizations {
  ...
  @override
  String sentReaction(String senderName, String reactionKey) => l10n.reactedWith(senderName, reactionKey);
  ...
  @override
  String youHaveWithdrawnTheInvitationFor(String targetName) => l10n.youHaveWithdrawnTheInvitationFor(targetName);
  ...
  @override
  String wasDirectChatDisplayName(String oldDisplayName) => l10n.wasDirectChatDisplayName(oldDisplayName);
